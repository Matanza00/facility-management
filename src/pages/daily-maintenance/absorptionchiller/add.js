...
const AddChillerForm = () => {
  ...
  const handleAddChiller = () => {
    setFormData((prev) => ({
      ...
      Chillers: [
        ...prev.Chillers,
        { ColdWaterIn: '', ColdWaterOut: '', ChillingWaterIn: '', ChillingWaterOut: '', assistantSupervisor: '' },
      ],
    }));
  };
  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto p-6 bg-gray-900 rounded-lg shadow-lg">
        <h2 className="text-2xl text-white font-semibold mb-6">Add Absorption Chiller</h2>
          ...
          <div className="mb-4">
            ...
            {formData.Chillers.map((entry, index) => (
              <div key={index} className="grid grid-cols-6 gap-2 mb-2">
                {['ColdWaterIn', 'ColdWaterOut', 'ChillingWaterIn', 'ChillingWaterOut', 'assistantSupervisor'].map(
                  (field) => (
                    <input
                      key={field}
                      type="text"
