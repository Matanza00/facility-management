              ...
              <table className="table-auto w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="border border-gray-300 px-4 py-2">Hot Water In (°C)</th>
                    <th className="border border-gray-300 px-4 py-2">Hot Water Out (°C)</th>
                    <th className="border border-gray-300 px-4 py-2">Exhaust Temp (°C)</th>
                    <th className="border border-gray-300 px-4 py-2">Furnace Pressure (bar)</th>
