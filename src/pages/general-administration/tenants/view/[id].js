      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        {tenant ? (
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="text-lg text-gray-600 mt-4">Total Area: {tenant.totalAreaSq} sq.m</p>

            <h3 className="text-xl font-medium text-gray-700 mt-6">Associated Areas</h3>
              ...
              <ul className="mt-4 space-y-4">
                {tenant.area.map((area) => (
                  <li key={area.id} className="bg-gray-100 p-4 rounded-md shadow-md">
                    ...
                    <div className="text-sm text-gray-600">Occupied Area: {area.occupiedArea || 0} sq.m</div>
